...
def app():
 ...
 st.write("""Imagine waking up every morning unsure if the water in your glass could harm your family. Not because you live in a desert, but because the very groundwater beneath your village carries hidden threats—high TDS, dangerous acidity, and unseen pollutants.
...
That’s where AquaSentinel steps in. Not just another fancy gadget, yeh ek silent guardian hai—a humble, powerful device built with love, tech, and a lot of heart. It's a smart, AI-powered IoT-based system that monitors water quality in real-time using sensors that detect pH, turbidity, dissolved oxygen, conductivity, and TDS. Think of it as a digital watchdog for your drinking water, alerting you before danger knocks.
But let’s rewind a bit.
Traditional water testing? It’s slow, expensive, and let’s be honest—gaav tak pahuchta hi nahi. Samples get sent to labs, reports take days, and by then, bachpan se leke budhape tak—entire lives are drinking poison without even realizing it.
...
And here’s the best part — it’s affordable. Matlab, ek gadget jo har gaav ka apna paani ka doctor ban sakta hai—aur bina bank tod diye. We’re not here to sell tech; we’re here to solve a very real, very painful problem.
...
Empowerment — because when you hand someone the power to test their own water, you don’t just give data, aap unhe unka haq wapas dete ho.
...
So if you’re reading this — kya aap hissa banna chahenge is mission ka?
A mission that isn’t about tech. It’s about trust, health, and hope. AquaSentinel is more than just a circuit and code — it’s a vachan that every child, every farmer, every mother, and every village deserves paani that doesn’t poison, but protects.
